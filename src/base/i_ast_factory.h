...
class IAstFactory {
 public:
  ...
  virtual nonterm_type CreateUnaryOp(UnaryOpType type, nonterm_type operand) = 0;
  virtual nonterm_type CreateBinaryOp(BinaryOpType type, nonterm_type left, nonterm_type right) = 0;
